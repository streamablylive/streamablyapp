...
const Home = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center ">
      <div className="h-full  mt-[240px] sm:mt-60 flex flex-col items-center">
        <button
          onClick={loading ? null : join}
          type="button"
        ...
        <div className="w-full h-3/4 flex flex-col items-center">
          <Hometoken />
          <div className="divider my-4 text-white w-[90%]">Direct Join</div>
          <Homejoin />
        </div>
      </div>
      ...
      <img
        ...
        className=" absolute top-0 right-10 object-cover rounded-full h-20 w-20 mr-15 mt-10 mb-5  "
      />
      {menu ? <Pfp /> : null}
    </div>
  );
